...
![Speech to Text](/NetCoreAI_01_OpenWhisperAudioTranskript/SpeechToText.jpg)
...
- 1 numaralý satýrda OpenAI dan aldýðýmýz key i yazýyoruzç
...
- 5. kýsýmda, eðer istek baþarýlý ise sonuç döndürülür. Artýk çýktýyý console da görebilirsiniz.
